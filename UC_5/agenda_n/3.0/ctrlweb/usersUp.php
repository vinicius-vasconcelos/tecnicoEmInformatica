			...
			<section id="listar">
				...
				<?php if($row = mysqli_fetch_array($result)) {?>
					<form action="#" method="post" id="formUser" name="formUser">
						<input type="hidden" name="textSenha" id="textSenha" value="<?= $row['idusers']?>">
						<input type="text" name="txtNome" id="txtNome" placeholder="Nome User" value="<?= $row['nome']?>">
						<input type="text" name="txtLogin" id="txtLogin" placeholder="Login" value="<?= $row['login']?>">
